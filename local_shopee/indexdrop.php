							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Registration<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="Vregistration.html">Vendor Registration</a></li>
                                    </ul>
                                </li> 
...
?>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="#"> <span class="pull-right"></span></span></a></li>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src= "../Magezine-main/<?php echo $row2["P_image"];?>" alt="" />
											<h2>Rs.<?php echo $row2["P_price"] ?></h2>
											<p></p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $row2["P_price"]?></h2>
												<p></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
  ...
  while($row3 = $result3->fetch_assoc()) {
	...
	?>                           
								<li><a href="#<?php echo $row3["C_name"];?>" data-toggle="tab"><?php echo $row3["C_name"];?></a></li>
								<?php
                                    }
                                  }
								  ?>
	...
	?>                           
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src= "../Magezine-main/<?php echo $row4["C_image"];?>" alt="" />
												<h2></h2>
												<p></p>
											</div>
										</div>
							...
							<div class="tab-pane fade" id="Headphones" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">

...
$sql2="SELECT * FROM `tbl_vendor`,tbl_product,tbl_user where tbl_product.Vendor_id=tbl_vendor.Vendor_id and tbl_user.U_pincode=tbl_vendor.V_pincode and tbl_user.U_pincode='$pincode' and tbl_product.P_name like '$pname'";

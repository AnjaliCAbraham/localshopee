...
$sql2="SELECT * FROM `tbl_vendor`,tbl_product,tbl_user where tbl_product.Vendor_id=tbl_vendor.Vendor_id and tbl_user.U_pincode=tbl_vendor.V_pincode and tbl_user.U_pincode='$pincode' and tbl_product.Category_id='5'";
			...
			<!-- <div class="row"> -->
				<!-- <div class="col-sm-9 padding-right"> -->
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Grocery</h2>
						<?php

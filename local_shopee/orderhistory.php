...
$sql="SELECT * ,tbl_product.P_price*tbl_cart.C_Qty as Total_Price FROM tbl_product,tbl_cart where tbl_product.Product_id=tbl_cart.Product_id and tbl_cart.User_id='$loginid' and Status!='Added'";			
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="cart.php" class="active">Order History</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">

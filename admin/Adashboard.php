...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard | Local Shopee</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!-- <div class="card-body"> -->
                         <div class="breadcrumb mb-4"><p>User Details</p></div>
                         <div class="breadcrumb mb-4"><p>Vendor Details</p></div>
                         <div class="breadcrumb mb-4"><p>Product Details</p></div>
                         <div class="breadcrumb mb-4"><p>Category Details</p></div>
                         <div class="breadcrumb mb-4"><p>Add Category</p></div>
                         <div class="breadcrumb mb-4"><p>Vendor Verification</p></div>

...
<html lang="en">
    <head>
        ...
        <title>Vendor Dashboard | Local Shopee</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!-- <div class="card-body"> -->
                         <div class="breadcrumb mb-4"><p>Product</p></div>
                         <div class="breadcrumb mb-4"><p>Stock</p></div>
                         <div class="breadcrumb mb-4"><p>Order</p></div>
                         <div class="breadcrumb mb-4"><p>Delivery</p></div>
                         <div class="breadcrumb mb-4"><p>Add Product</p></div>
